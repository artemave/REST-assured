...
Another use for redirects is setting up a "default" double that matches multiple fullpaths. This is limited to GETs since by definition temporary redirects are converted to GETs.
