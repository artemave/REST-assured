...
Rest-assured provides client library to work with doubles. Check out full reference in 'Ruby API' section of https://www.relishapp.com/artemave/rest-assured). Set it up in env.rb/spec_helper.rb first:
