...
Rest-assured provides client library to work with doubles. Check out 'Ruby API' section of [documentation](https://www.relishapp.com/artemave/rest-assured) for full reference. Set it up in env.rb/spec_helper.rb first:
